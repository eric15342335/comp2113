...
bool mergeBoundingBoxes(int & x1, int & y1, int & w1, int & h1, int x2, int y2, int w2, int h2) {
    ...
    // however, this assumption is not always true as the question didn't state that
    // test cases may provide different inputs, hence we need to check
    ...
    // compare the bottom right corner of the first box with the top left corner of the second box
