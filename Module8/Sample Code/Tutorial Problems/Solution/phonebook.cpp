...
// Sort the phonebook records stored in the array parameter by ascending order
// of the name. 'nRec' specifies the number of records stored in the array
// parameter
...
// Save phonebook data stored in the array parameter into a file. 'nRec'
// specifies the number of records stored in the array parameter. Return 0 if
    ...
    while (choice != '0') {
        ...
        case '6':
            ...
            cout << "There are now " << num_records
                 << " record(s) in the phonebook." << endl
                 << endl;
            break;
...
void grow_phonebook(PhoneRec *& pb, int & pb_size, int n) {
    ...
    cout << "---> phonebook size enlarged to hold a maximum of " << pb_size
         << " records." << endl;
